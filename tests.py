...
from helpers import fetch_all_invoices, preprocess_invoices, compute_net_revenue_and_churn
...
class TestInvoiceProcessing(unittest.TestCase):
    ...
    def test_fetch_all_invoices(self, mock_get):
        ...
        mock_response.json.return_value = {
            'status_code': 200,
            'body': {
                'data': [{'invoice_date': '2021-11-01', 'contract_id': 'A', 'original_billing_amount': 200}],
                'total_pages': 1,
                'page': 1
            }
        }
    ...
    def test_preprocess_invoices(self):
        ...
        """
        invoices = [
            {"invoice_date": "2021-11-01", "contract_id": "A", "original_billing_amount": 200},
            {"invoice_date": "2021-11-15", "contract_id": "A", "original_billing_amount": 150},
            {"invoice_date": "2021-12-01", "contract_id": "B", "original_billing_amount": 100},
            {"invoice_date": "2021-12-20", "contract_id": "B", "original_billing_amount": 50},
        ]
    ...
    def test_compute_net_revenue_and_churn(self):
        ...
        invoices = [
            {"invoice_date": "2021-11-01", "contract_id": "A", "original_billing_amount": 200},
            {"invoice_date": "2021-12-01", "contract_id": "A", "original_billing_amount": 200},
            {"invoice_date": "2022-01-01", "contract_id": "A", "original_billing_amount": 0},
            {"invoice_date": "2022-02-01", "contract_id": "A", "original_billing_amount": 0},
        ]
        df = preprocess_invoices(invoices)
